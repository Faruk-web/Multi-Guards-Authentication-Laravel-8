  ...
  <div class="card card-developer-meetup">
    ...
    <div class="card-body">
      ...
      <div class="avatar-group">
        ...
        >
          <img
            src="{{ asset('backend') }}/app-assets/images/portrait/small/avatar-s-20.jpg"
            alt="Avatar"
            width="33"
            height="33"
          />
  ...
  <div class="card card-browser-states">
    ...
    <div class="card-body">
      <div class="browser-states">
        <div class="d-flex">
          <img
            src="{{ asset('backend') }}/app-assets/images/icons/google-chrome.png"
            class="rounded me-1"
            height="30"
            alt="Google Chrome"
          />
      ...
      <div class="browser-states">
        <div class="d-flex">
          <img
            src="{{ asset('backend') }}/app-assets/images/icons/mozila-firefox.png"
            class="rounded me-1"
            height="30"
            alt="Mozila Firefox"
          />
      ...
      <div class="browser-states">
        <div class="d-flex">
          <img
            src="{{ asset('backend') }}/app-assets/images/icons/apple-safari.png"
            class="rounded me-1"
            height="30"
            alt="Apple Safari"
          />
      ...
      <div class="browser-states">
        <div class="d-flex">
          <img
            src="{{ asset('backend') }}/app-assets/images/icons/internet-explorer.png"
            class="rounded me-1"
            height="30"
